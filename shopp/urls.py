...
from shopp.views import Product_detailView, ShopsView, delete_view, product_delete_view, BusinessAdressFormView,Product_detailView,ResidentAddressFormView
...
urlpatterns = [
    ...
    re_path('shopp/businessadress_form/', BusinessAdressFormView.as_view(), name='businessadress_form'),
    re_path('shopp/residentadressform/', ResidentAddressFormView.as_view(), name='residentadressform'),
    re_path(r'^(?P<uniqueadress>\d+)/(?P<slug>[-\w]+)/$', Product_detailView.as_view(), name='business_detail'),
    #re_path(r'^(?P<pk>\d+)/(?P<slug>[-\w]+)/$', Product_detailView.as_view(), name='business_detail_with_pk'),
