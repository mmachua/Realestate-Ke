...
from .import views
from .views import  ShopFormView  , ClientFormUpdate ,ClientFormView, ShopFormUpdate

from shopp.views import delete_view, Resident_detailView
app_name='Profile'
...
urlpatterns = [
    ...
    re_path(r'^(?P<uniqueadress>\d+)/(?P<date>[-\w]+)/$', Resident_detailView.as_view(), name='detail'),
